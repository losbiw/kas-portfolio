...
const pictures: Picture[] = [
  {
    ...
    alt: 'Something quickly done and heavily referenced, decided to draw one of my OCs who I haven’t drawn in a while. Stratous, son of Horus lol',
    direction: Direction.Right,
    size: Size.Small,
  },
  {
    src: '/portfolio/submissive-fantasy-lmao.jpg',
    alt: 'Hey there, here’s a commission done for @episode.pdv !!',
