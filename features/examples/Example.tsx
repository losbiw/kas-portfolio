...
const Example: FC<Props> = ({
  ...
  return (
    <div className={`bg-gray-200 p-1 rounded-huge relative shadow-xl ${offset} ${calcSize} ${align}`}>
      <div className={`bg-gray-700 transform p-1 sm:p-2 w-full h-full rounded-huge ${direction}`}>
