...
const links = ['', 'portfolio', 'contact', 'prices'];
    ...
    <nav className="container flex justify-between pt-10 sm:pt-16">
      ...
      <div
        className={
          ...
          backdrop-blur-sm lg:backdrop-blur-none fixed items-center lg:static lg:justify-between lg:w-auto lg:bg-transparent lg:h-auto lg:flex-row`
        }
        style={{
